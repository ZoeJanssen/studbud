...
function displayNumberOfImgs(){
  if(imagesObject.length > 0){
    ...
    document.getElementById("state").innerHTML = imagesObject.length + " image" + ((imagesObject.length > 1) ? "s" : "") + " set as profile picture";
    
    document.getElementById("deleteImgs").style.display = "inline";
    
  } else {
    document.getElementById("state").innerHTML = "Upload Profile Picture.";
